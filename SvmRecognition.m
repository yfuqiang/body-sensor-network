...
[newTrainData,ps1]=scale_data(TrainData,1,0);
[newTestData,ps2]=scale_data(TestData,1,0);

model = svmtrain(TrainLabel,newTrainData,'-s 0 -t 1 -c 2 -g 1.8');
[predict_lebel]=svmpredict(TestLabel,newTestData,model);
